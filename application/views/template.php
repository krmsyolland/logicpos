...
<head>
  ...
  <title>Logic | Point Of Sales</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?=base_url('dashboard')?>" class="logo">
      ...
      <span class="logo-mini"><b>LGC</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Logic | POS</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?=base_url()?>assets/dist/img/prof.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?=$this->fungsi->user_login()->username?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?=base_url()?>assets/dist/img/prof.jpg" class="img-circle" alt="User Image">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2019 <a href="https://instagram/@krmsyolland">Krmsyolland</a>.</strong> All rights
    reserved.
  </footer>
